...
operate on `ema.Model` objects, or arrays represention various
structural matrices.
"""
...
def kStaticCondensation(K, dofs=None, idxs=None):
    ...
    K_matrix: np.ndarray or ema.Structural_Matrix
...
def StaticCondensation(K_matrix, M_matrix=None, dofs=None, idxs=None):
    ...
    if (dofs is None and idxs is None) and (Mass_matrix is not None):
        # This method may require ema.Stiffness_matrix and ema.Mass_matrix objects as 
